...
ActiveRecord::Schema.define(version: 20141002170925) do
  ...
  add_index "responses", ["answer_choice_id", "respondent_id"], name: "index_responses_on_answer_choice_id_and_respondent_id", using: :btree
